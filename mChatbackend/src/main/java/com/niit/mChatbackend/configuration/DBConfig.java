...
import com.niit.mChatbackend.model.Chat;
...
public class DBConfig {
	//create an instance
		...
		public SessionFactory sessionFactory() {
			...
			Class classes[]=new Class[]{BlogPost.class,Job.class,User.class,BlogComment.class,ProfilePicture.class,Friend.class,Chat.class};
		...
		public DataSource getDataSource() {
		    ...
		    dataSource.setUrl("jdbc:mysql://localhost:3306/mchat");
